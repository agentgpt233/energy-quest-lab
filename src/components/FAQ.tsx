...
const faqs = [
  ...
  },
  {
    ...
    answer: "Да. Все данные хранятся в зашифрованном виде и не передаются третьим лицам.",
  },
  {
    question: "Это платно?",
    answer: "Нет. Приложение бесплатно. Энергию можно получить за витакоины — их легко заработать в игре или купить. При активном участии ресурсов хватает на всё ⚡",
  },
  {
    question: "Работает без фото?",
    answer: "Да. Можно добавлять продукты вручную или по штрих-коду.",
  },
  {
    question: "Откуда берутся нормы?",
    answer: "Все нормы основаны на СанПиН РФ и международных стандартах (ВОЗ, EFSA).",
  },
];
