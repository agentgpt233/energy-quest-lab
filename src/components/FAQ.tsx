...
const faqs = [
  ...
  },
  {
    ...
    answer: "💬 Первые изменения вы почувствуете через 5-7 дней регулярного использования приложения и следования рекомендациям. Полное восстановление баланса основных нутриентов занимает 3-4 недели при правильной коррекции питания.",
  },
  {
    question: "Нужно ли покупать витамины и БАДы?",
    answer: "💬 Не обязательно! Приложение в первую очередь помогает скорректировать рацион питания натуральными продуктами. В большинстве случаев этого достаточно. БАДы рекомендуются только при серьёзных дефицитах — и только после консультации с врачом.",
  },
  {
